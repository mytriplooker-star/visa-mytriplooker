...
const destinations = [
  ...
  { name:"China",              slug:"china",            flag:"🇨🇳", type:"Sticker",  days:"15–20",  price:"₹6,999",  popular:false },
  { name:"Turkey",              slug:"turkey",           flag:"🇹🇷", type:"eVisa",    days:"2–3",    price:"₹3,999",  popular:true  },
  { name:"Egypt",               slug:"egypt",            flag:"🇪🇬", type:"eVisa",    days:"3–5",    price:"₹2,999",  popular:true  },
  { name:"Azerbaijan",          slug:"azerbaijan",       flag:"🇦🇿", type:"eVisa",    days:"3",      price:"₹2,499",  popular:true  },
  { name:"Kenya",               slug:"kenya",            flag:"🇰🇪", type:"eVisa",    days:"3–5",    price:"₹3,299",  popular:false },
  { name:"Tanzania",            slug:"tanzania",         flag:"🇹🇿", type:"eVisa",    days:"3–5",    price:"₹3,299",  popular:false },
  { name:"Uganda",              slug:"uganda",           flag:"🇺🇬", type:"eVisa",    days:"3–5",    price:"₹3,299",  popular:false },
  { name:"Morocco",             slug:"morocco",          flag:"🇲🇦", type:"Visa-free",days:"90",     price:"Free",    popular:false },
  { name:"Mauritius",           slug:"mauritius",        flag:"🇲🇺", type:"Visa-free",days:"90",     price:"Free",    popular:false },
  { name:"Seychelles",          slug:"seychelles",       flag:"🇸🇨", type:"Visa-free",days:"90",     price:"Free",    popular:false },
  { name:"Rwanda",              slug:"rwanda",           flag:"🇷🇼", type:"Visa-free",days:"30",     price:"Free",    popular:false },
  { name:"Jordan",              slug:"jordan",           flag:"🇯🇴", type:"VOA",      days:"30",     price:"₹1,799",  popular:false },
  { name:"Georgia",             slug:"georgia",          flag:"🇬🇪", type:"Visa-free",days:"365",    price:"Free",    popular:false },
  { name:"Kazakhstan",          slug:"kazakhstan",       flag:"🇰🇿", type:"Visa-free",days:"14",     price:"Free",    popular:false },
  { name:"Uzbekistan",          slug:"uzbekistan",       flag:"🇺🇿", type:"eVisa",    days:"3–5",    price:"₹2,499",  popular:false },
  { name:"Laos",                slug:"laos",             flag:"🇱🇦", type:"VOA",      days:"30",     price:"₹1,299",  popular:false },
  { name:"Macao",               slug:"macao",            flag:"🇲🇴", type:"Visa-free",days:"30",     price:"Free",    popular:false },
  { name:"Fiji",                slug:"fiji",             flag:"🇫🇯", type:"Visa-free",days:"120",    price:"Free",    popular:false },
  { name:"Vanuatu",             slug:"vanuatu",          flag:"🇻🇺", type:"Visa-free",days:"120",    price:"Free",    popular:false },
  { name:"Zambia",              slug:"zambia",           flag:"🇿🇲", type:"eVisa",    days:"3–5",    price:"₹3,299",  popular:false },
  { name:"Zimbabwe",            slug:"zimbabwe",         flag:"🇿🇼", type:"eVisa",    days:"3–5",    price:"₹2,499",  popular:false },
  { name:"Ecuador",             slug:"ecuador",          flag:"🇪🇨", type:"eVisa",    days:"5–7",    price:"₹3,499",  popular:false },
  { name:"Trinidad & Tobago",   slug:"trinidad-tobago",  flag:"🇹🇹", type:"Visa-free",days:"90",     price:"Free",    popular:false },
  { name:"Jamaica",             slug:"jamaica",          flag:"🇯🇲", type:"Visa-free",days:"–",      price:"Free",    popular:false },
  { name:"Saint Lucia",         slug:"saint-lucia",      flag:"🇱🇨", type:"VOA",      days:"42",     price:"₹1,299",  popular:false },
  { name:"Senegal",             slug:"senegal",          flag:"🇸🇳", type:"Visa-free",days:"90",     price:"Free",    popular:false },
  { name:"Mozambique",          slug:"mozambique",       flag:"🇲🇿", type:"eVisa",    days:"3–5",    price:"₹2,499",  popular:false },
];
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        @media (max-width:767px) {
          ...
          .hero-search input { font-size:15px !important; }
          .hero-stats { flex-direction:row !important; flex-wrap:wrap !important; gap:20px !important; padding:20px !important; }
          .dest-grid { grid-template-columns:1fr !important; }
          .cta-banner { flex-direction:column !important; padding:32px 24px !important; }
      ...
      <footer style={{ borderTop:"1px solid rgba(255,255,255,0.05)", padding:"44px 40px 32px" }}>
        <div style={{ maxWidth:1200, margin:"0 auto", display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:24 }}>
          ...
          <div style={{ display:"flex", gap:28, flexWrap:"wrap" }}>
            {([["/privacy","Privacy Policy"],["/terms","Terms of Service"],["mailto:sales@mytriplooker.com","Contact Us"],["/track","Track Application"],["/login","Sign In"]] as [string,string][]).map(([href,label])=>(

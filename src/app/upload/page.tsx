...
export default function UploadPage() {
  ...
  return (
    <div style={{ fontFamily: "'Outfit', sans-serif", background: "#08080F", color: "#F5F0E8", minHeight: "100vh" }}>
      ...
      {/* Sticky Pay CTA */}
      <div style={{ position: "sticky", bottom: 0, background: "rgba(8,8,15,0.97)", backdropFilter: "blur(20px)", borderTop: "1px solid rgba(212,175,106,0.15)", padding: "16px 40px", display: "flex", justifyContent: "space-between", alignItems: "center", zIndex: 100 }}>
        <div>

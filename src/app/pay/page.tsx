  ...
  return (
    <div style={{ fontFamily: "'Outfit', sans-serif", background: "#08080F", color: "#F5F0E8", minHeight: "100vh" }}>
      ...
      <nav style={{ height: 60, background: "rgba(8,8,15,0.95)", backdropFilter: "blur(20px)", borderBottom: "1px solid rgba(212,175,106,0.12)", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 32px", position: "sticky", top: 0, zIndex: 100 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <span style={{ fontSize: 13, color: "#2ECC8B" }}>🔒 Secured by Razorpay</span>
        </div>
      </nav>
      ...
      {step === "success" && (
        <div style={{ maxWidth: 520, margin: "80px auto", padding: "0 24px", textAlign: "center", animation: "fadeUp 0.5s ease both" }}>
          ...
          <a href="/track" style={{ display: "inline-block", background: "linear-gradient(135deg,#D4AF6A,#E8C977)", color: "#08080F", fontWeight: 700, padding: "14px 36px", borderRadius: 10, textDecoration: "none", fontSize: 15 }}>
